...
.switch-field3 label:first-of-type {
  border-radius: 4px 0 0 4px;
}

.switch-field3 label:last-of-type {
  border-radius: 0 4px 4px 0;
}
...
function voteAdd(){
	...
	if(qLength<3){
		...
		$('#voteQuestionList').append('<div class="form-group voteDelview'+qLength+'"><div class="switch-field"><input type="radio"  id="ck'+qLength+'" name="ckRadio'+qLength+'" value="checkbox" /> <label for="ck'+qLength+'"><h4>다중선택</h4></label><input type="radio"  id="radio'+qLength+'" name="ckRadio'+qLength+'" value="radio" /> <label for="radio'+qLength+'"><h4>선택</h4></label></div></div>');
